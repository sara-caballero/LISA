...
def saveAndExit(event=0):
    ...
    if len(sys.argv) < 2:
        filepath = "../rec_faciale/easy_facial_recognition-master\known_faces/" + str(id_photo) + ".png"            #chemin du repertoire où on veut mettre le fichier
    else:
        filepath = sys.argv[1]
