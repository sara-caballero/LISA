...
def open_reco_faciale():
    ...
    if nom_reco == "Unknown":
        messagebox.showerror("Error", "Visage non reconnu. Veuillez vous inscrire à LISA ou vous identifier avec votre e-mail.")
        exit(1)
    print(type(nom_reco))
...
mail_button = Button(welcome_window, text="Identifiants", command=open_connexion_mail)
